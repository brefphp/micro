...
abstract class Controller implements RequestHandlerInterface
{
    ...
    public function queryParameter(ServerRequestInterface $request, string $parameter, mixed $default = null): mixed
    {
        return $request->getQueryParams()[$parameter] ?? $default;
    }

    public function bodyField(ServerRequestInterface $request, string $field, mixed $default = null): mixed
    {
